  ...
  return (
    <>
      ...
      <div className="px-44">
        <div className="flex justify-between px-4 mt-6">
          ...
          <div className="flex">
            ...
            <div className="flex items-center ml-4">
              ...
              <div className="ml-1 underline">Save</div>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="pl-4">
              ...
              <div className="flex items-center mb-2">
                ...
                <div className="ml-5 margin-icons3">Free washer - in unit</div>
                {/* ////////////// */}
                <div className="flex items-center mb-2">
            ...
            <div className="border p-4 shadow-lg rounded-lg reserve-container">
              ...
              <div className="mt-4 ">
                <div className="flex justify-between mb-2">
                  <div className="underline">$495 x 5 nights</div>
                  <div>$2,475</div>
                </div>
                <div className="flex justify-between mb-2">
        ...
        {/* ////stop */}
        <div className="border border-slate-100 mx-4 mt-6 mb-8"></div>
        <div className="flex items-center pl-4">
          ...
          <div className="font-semibold text-2xl">3.78</div>
          <div className="pb-5 mx-1 text-4xl">.</div>
          <div className="font-semibold text-2xl">124 reviews</div>
        </div>
        <div className="flex">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="review1 p-4 ">
            <div className="flex items-center mb-1.5">
              ...
              <div className="ml-3">
                ...
                <div className="text-gray-500 text-sm">Atlanta, Georgia</div>
              </div>
            </div>
            <div className="flex items-center ">
              {[...Array(5)].map((_, i) => (
            ...
            <div className="mb-2">
              I stayed at Jessica's cozy apartment for a weekend and had a
              wonderful experience. Her review was spot-on, highlighting the
              cleanliness and great location of the property. Highly recommend
              her for accurate and helpful feedback...
            </div>
          ...
          <div className="review1 p-4 ">
            ...
            <div>
              Jessica's review was very detailed and helpful. She highlighted
              both the positive aspects and a few minor issues of the property.
              I appreciated her honest feedback, which made my decision much
              easier...
            </div>
            <div className="font-semibold underline mt-6">Show more</div>
          </div>
        ...
        <div className="pl-4">
          ...
          <div>
            The neighborhood surrounding this Airbnb is a tranquil and
            picturesque area, perfect for those seeking a peaceful retreat. It's
            located just a short walk from local parks and cafes, offering a
            blend of natural beauty and urban convenience. The community is
            friendly and welcoming, making it easy to feel at home.
        ...
        <div className="pl-4 mt-12 mb-6">
          ...
          <div className="host-container rounded-2xl">
            <div className="flex">
              <div className="">
                <div className="bg-white shadow-xl flex items-center rounded-3xl p-6">
